...
// ===============================================================
  ...
  hotelTodoList: [
    ...
    {
      "total": 2,
      "type": "EXCEPITON" //待办事项类型 ，PREPAY预付款确认,IDENTITY身份检验、LVYE旅业上报、INVOICE极速开票、CHECKOUT退房
    },
    {
      "total": 2,
      "type": "NOCHECKIN" //待办事项类型 ，PREPAY预付款确认,IDENTITY身份检验、LVYE旅业上报、INVOICE极速开票、CHECKOUT退房
    }
  ],
  ...
  AbsentList: [
    {
      remind_noshow_id: "qwertyui23456789",
      room_no: "203",
      guest_name: "张三",
      order_no: "1234567890wertyui",
      owner: "李四",
      owner_tel: "18721244171",
      status: "READ",
      checkin_status: "I",
      create_time: 12312312312313
    },
    {
      remind_noshow_id: "qwertyui23456789",
      room_no: "303",
  ...
  LiveINlist: {
    "config": {
      enable_out_of_cash_pledge_refund: true / false,//是否允许退款金额超过押金
      refund_amount_source: "false"//退款方式PMS-PMS/ORDER_BILL-订单账单表/MANUAL-手动
    },
    "content": [
      {
        order_id: "230420402402401",//订单号
